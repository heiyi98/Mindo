...
import { LogOut, Trash2, ChevronRight, Package } from 'lucide-react';
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 rounded-xl text-sm font-light transition-colors"
                style={{
                  background: 'hsl(var(--muted))',
                  color: 'hsl(var(--foreground))',
                }}
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl text-sm font-light transition-colors disabled:opacity-30"
                style={{
